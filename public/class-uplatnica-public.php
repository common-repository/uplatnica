...
class Uplatnica_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/uplatnica-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/uplatnica-public.js', array( 'jquery' ), $this->version, true );
	 ...
	 *
	 * Shortcode can take attributes like [uplatnica-shortcode attribute='123']
	 * Shortcodes can be enclosing content [uplatnica-shortcode attribute='123']custom content[/uplatnica-shortcode].
	 *
